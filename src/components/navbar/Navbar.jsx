    ...
    <header className='w-full z-10 fixed py-6 px-16 lg:px-24 flex items-center justify-between'>
      ...
      <nav className='hidden xl:w-full lg:flex justify-center'>
        <ul className='text-center uppercase flex gap-8'>
          <li className='text-base font-bold pb-8 md:pb-0'><a className='hover:underline underline-offset-8' href="#">Home</a></li>
          <li className='text-base font-bold pb-8 md:pb-0'><a className='hover:underline underline-offset-8' href="#about">Program</a></li>
          <li className='text-base font-bold pb-8 md:pb-0'><a className='hover:underline underline-offset-8' href="#results">Results</a></li>
          <li className='text-base font-bold pb-8 md:pb-0'><a className='hover:underline underline-offset-8' href="#contact">Contact Us</a></li>
        </ul>
      </nav>
      ...
      >
        <ul className='text-center uppercase'>
          ...
          <li className='text-lg font-bold pb-8'><a className='hover:underline underline-offset-[16px]' href="#contact" onClick={() => setOpenMenu(false)}>Contact Us</a></li>
        </ul>
