    ...
    <div className='w-full h-screen bg-[url("/assets/hero-img-mobile.png")] md:bg-[url("/assets/hero-img-desktop.png")] bg-right-top bg-no-repeat'>
      ...
      <div className='flex md:px-8 xl:justify-center'>
        <div className='md:w-[484px] pt-[112px] md:pt-40 px-16 flex flex-col justify-center'>
          <h3 className='text-sm'>author's slim body program</h3>
          <h1 className='text-4xl md:text-5xl leading-8 font-bold mt-[18px]'>Get slimmer in <strong className='text-sbPallet-accent'>56</strong> days</h1>
          <h2 className='text-sm md:text-base leading-relaxed mt-[18px] mb-[18px]'>
      ...
      {/* Cards */}
      <div className='pt-10 px-12 flex flex-wrap md:justify-center gap-3 md:gap-14'>
        {/* card #1 */}
        <div className='w-[117px] sm:w-36 md:w-56 h-36 md:h-44 p-1 rounded-xl bg-sbPallet-cardBg flex flex-col items-center justify-center'>
          <div>
            <img src="/assets/dumb-bell.png" alt="Dumb-bell Clipart" />
          </div>
          <h2 className='text-sm font-bold mt-2'>Fast</h2>
          <p className='text-xs text-center leading-relaxed mt-2'>First results after the first weeks</p>
        </div>
        {/* card #2 */}
        <div className='w-[117px] sm:w-36 md:w-56 h-36 md:h-44 p-1 rounded-xl bg-sbPallet-cardBg flex flex-col items-center justify-center'>
          <div>
          ...
          <p className='text-xs text-center leading-relaxed mt-2'>Weight loss without fasting or dieting</p>
        </div>
        {/* card #3 */}
        <div className='w-[117px] sm:w-36 md:w-56 h-36 md:h-44 p-1 rounded-xl bg-sbPallet-cardBg flex flex-col items-center justify-center'>
          <div>
          ...
          <p className='text-xs text-center leading-none mt-2'>Under the supervision of experienced professionals</p>
        </div>
        {/* card #4 */}
        <div className='w-[117px] sm:w-36 md:w-56 h-36 md:h-44 p-1 rounded-xl bg-sbPallet-cardBg flex flex-col items-center justify-center'>
          <div>
          ...
          <p className='text-xs text-center leading-none mt-2'>Materials and recommendations online</p>
        </div>
      </div>
    </div>
  )
